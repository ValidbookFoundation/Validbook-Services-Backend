...
class AuthorStoryNotification extends Notification implements NotificationInterface
{
    public function getText(User $sender, BaseObject $object = null)
    {
        $text = "<a>" . $sender->getFullName() . "</a><span>commented on your</span>story.";
        return $text;
    }
...
<a style=\"text-decoration: none; font-weight: bold;\" href=\"" . $sender->getUrl() . "\">" . $sender->getFullName() . "</a>, commented on your story. " . \Yii::$app->id . ".<br>
...
";
    ...
    {
        return $sender->getFullName() . ' commented on your story';
    }
}